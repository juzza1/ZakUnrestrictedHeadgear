// Same as UICustomize_SkirmisherHead but with upper face props ui lines copypasted from UICustomize_Head

class UICustomize_SkirmisherHead_ZakUnrestricted extends UICustomize_Head;
